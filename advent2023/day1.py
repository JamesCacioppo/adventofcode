...
def find_first_and_last_numbers(line: str) -> tuple[int, int]:
    ...
    for search_pattern in number_search_patterns:
        ...
        if first_hit_location != -1: # If find() returns -1 then do nothing
            if first_hit_location < matches[matches_dict_key][0] or matches[matches_dict_key][0] == -1: 
...
if __name__ == '__main__':
    ...
    print(f'The sum of calibration values for puz 2 is {sum_calibration_values(calibration_value_list)}')